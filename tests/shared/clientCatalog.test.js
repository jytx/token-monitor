...
test('derived KNOWN_CLIENTS keeps the established id order', () => {
  ...
  assert.equal(
    KNOWN_CLIENTS,
    'claude,codex,opencode,hermes,openclaw,cursor,antigravity,cline,kimi,qwen,grok,copilot,pi,zed,kilo,commandcode,micode,minimax,zcode,kiro,codebuddy,workbuddy,proma,qodercn,reasonix,dsh,cherrystudio,lmstudio,unsloth'
  );
});
